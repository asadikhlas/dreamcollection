...
<body class="animsition">
  ...
  $_GET['submit'] = "";
          ...
          if($_GET['submit'] == "success"){
                  echo "<div class='alert alert-success' role='alert' style='width: 100%; text-align: center; margin: 0 auto 0 auto'>Your Ad Has Been Submited Successfully!!</div><br>";
                  //connect::debug($_GET);
          ...
          } elseif($_GET['submit'] == "passchanged"){
                  echo "<div class='alert alert-success' role='alert' style='width: 100%; text-align: center; margin: 0 auto 0 auto'>Password Changed Succcessfully!</div><br>";
          }
          elseif($_GET['submit'] == "deleted"){
                  echo "<div class='alert alert-success' role='alert' style='width: 100%; text-align: center; margin: 0 auto 0 auto'>Your Ad Has Been Deleted Successfully.</div><br>";
          }
			...
			<div class="flex-w flex-sb-m p-b-52">
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					...
					<form action="" method="get">
						<div style="display: none;" class="hidden-submit"><input type="submit" value="" name="submitBtn" tabindex="-1"/></div>
            ...
            if($noOfPages > 1){ //pagination would show when total pages($noOfPages) are greater then 1... 
              ...
              if($currentPage > 1){ //if current page is greater then 1 then < (precious page indicator) would show.
                echo "<li class='page-item' style='background-color:#717fe0; border-color:#717fe0'>
				      <a class='page-link' style='color:#717fe0'; href='adminallproduct.php?page=$prevPage' aria-label='Previous'>
                ...
                for($page=$currentPage - 1; $page<= $currentPage + 1; $page++){//looping throgh page buttons.
                  if($currentPage == $page){//making current page active(current page)
                    //echo "current";
                      ...
                      echo "<li class='page-item'><a class='page-link' href='adminallproduct.php?page=$page'>$page</a></li>";
                    }  
                  }
                }
              ...
              if($noOfPages > 1 AND $currentPage < $noOfPages){
                ...
                echo "<a class='page-link' style='color:#717fe0;' href='adminallproduct.php?page=$nextPage' aria-label='Next'>
