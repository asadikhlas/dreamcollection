...
<body class="animsition">
    	<!-- Modal1 -->
	  	<?php
                      ...
                      $q = "SELECT DISTINCT (p.postId), i.image ,p.postName, p.postType, p.postPrice, p.postCategory, p.postDesc, p.postDate, i.image from images i RIGHT JOIN postad p ON i.postId = p.postId WHERE p.postId = $id GROUP BY p.postId";
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				...
				<div class="row">
							...
							//echo "<div class='slick3 gallery-lb'>";
								echo "<div class='item-slick3' data-thumb='PostImg/$image[image]'>";
									echo "<div class='wrap-pic-w pos-relative'>";
										echo "<img src='PostImg/$image[image]' alt='IMG-PRODUCT'>";
				 ...
				 <p  style="text-align: right;"><?php echo $data['postDate']; ?></p>
					</div>
				</div>
				</div>
			</div>
